...
public abstract class Setting
{
    ...
    /// Sets the value of the setting to be the last saved value, or the default if there is no saved value
    protected abstract void SetInitialValue(float defaultValue);
    /// Called when the slider has been moved / button has been pressed, changes the value of the setting so that other scripts can use it
